...
fn tr_es(key: TrKey) -> &'static str {
    match key {
        ...
        TrKey::ArmedSwap1of2 => "Cambiar activo 1/2",
        ...
        // Tooltip titles
        TrKey::TooltipSwapTitle => "Habilidad: Cambiar",
        ...
        TrKey::TooltipBoonSparkDesc => "Las chispas rescatadas otorgan +25 puntos adicionales.",
        TrKey::TooltipBoonPowerDesc => "Crear núcleos especiales otorga +12 puntos.",
        ...
        TrKey::ChooseOneModifier => "Elige 1 modificador",
        TrKey::BoonSelectInstruction => "Selecciona un boon para seguir",
...
fn tr_en(key: TrKey) -> &'static str {
    match key {
        ...
        TrKey::ArmedSwap1of2 => "Swap active 1/2",
        ...
        // Tooltip titles
        TrKey::TooltipSwapTitle => "Ability: Swap",
        ...
        TrKey::ChooseOneModifier => "Choose 1 modifier",
        TrKey::BoonSelectInstruction => "Select a boon to continue",
