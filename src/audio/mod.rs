...
use crate::gameplay::{
    CaptureBatch, PowerCombo, PowerConsumed, PowerCreated, ScoreDrained, SwapFailed,
};
...
fn on_chain_pop(
    ...
    if trigger.cascade_depth <= 1 {
        ...
        let pitch = (1.0 + trigger.cascade_depth.saturating_sub(1) as f32 * CASCADE_PITCH_STEP)
            .min(CASCADE_PITCH_MAX);
